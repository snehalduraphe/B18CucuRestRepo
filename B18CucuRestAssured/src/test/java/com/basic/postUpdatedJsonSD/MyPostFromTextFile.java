...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username) throws IOException{
		...
		//Read data from file
		String data = ""; 
	    data = new String(Files.readAllBytes(Paths.get("C:\\B18CucuRestAssured\\src\\test\\java\\com\\basic\\postUpdatedJsonSD\\user.json"))); 
...
//		 long time = date.getTime();
		 ...
		 String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Timestamp(date, null));



		 
	    JSONObject object=new JSONObject(data);
	    object.put("name", username+timeStamp);
